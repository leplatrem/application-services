...
["autofill",["",[["db",[["models",[],["address.rs","credit_card.rs","mod.rs"]]],["addresses.rs","credit_cards.rs","mod.rs","schema.rs","store.rs"]],["sync",[["address",[],["incoming.rs","mod.rs","name_utils.rs","outgoing.rs"]],["credit_card",[],["incoming.rs","mod.rs","outgoing.rs"]]],["common.rs","engine.rs","mod.rs"]]],["encryption.rs","error.rs","lib.rs"]]],\
["cli_support",["",[],["fxa_creds.rs","lib.rs","prompt.rs"]]],\
["crashtest",["",[],["lib.rs"]]],\
["debug_ingestion_sizes",["",[],["debug_ingestion_sizes.rs"]]],\
["dump",["",[],["client.rs","error.rs","lib.rs"]]],\
...
["nimbus",["",[["stateful",[["client",[],["fs_client.rs","http_client.rs","mod.rs","null_client.rs"]]],["behavior.rs","dbcache.rs","enrollment.rs","evaluator.rs","matcher.rs","mod.rs","nimbus_client.rs","persistence.rs","targeting.rs","updating.rs"]]],["defaults.rs","enrollment.rs","error.rs","evaluator.rs","json.rs","lib.rs","metrics.rs","sampling.rs","schema.rs","strings.rs","targeting.rs"]]],\
["nimbus_cli",["",[["output",[],["deeplink.rs","features.rs","fetch.rs","fml_cli.rs","info.rs","mod.rs","server.rs"]],["sources",[],["experiment.rs","experiment_list.rs","filter.rs","manifest.rs","mod.rs"]],["updater",[],["mod.rs","taskcluster.rs"]]],["cli.rs","cmd.rs","config.rs","feature_utils.rs","main.rs","protocol.rs","value_utils.rs","version_utils.rs"]]],\
["nimbus_fml",["",[["backends",[["kotlin",[["gen_structs",[],["bundled.rs","common.rs","enum_.rs","feature.rs","filters.rs","imports.rs","mod.rs","object.rs","primitives.rs","structural.rs"]]],["mod.rs"]],["swift",[["gen_structs",[],["bundled.rs","common.rs","enum_.rs","feature.rs","filters.rs","imports.rs","mod.rs","object.rs","primitives.rs","structural.rs"]]],["mod.rs"]]],["experimenter_manifest.rs","frontend_manifest.rs","info.rs","mod.rs"]],["client",[],["config.rs","descriptor.rs","inspector.rs","mod.rs"]],["command_line",[],["commands.rs","mod.rs","workflows.rs"]],["defaults",[],["hasher.rs","merger.rs","mod.rs","validator.rs"]],["editing",[],["cursor_position.rs","error_converter.rs","error_kind.rs","error_path.rs","mod.rs","values_finder.rs"]],["schema",[],["hasher.rs","mod.rs","types.rs","validator.rs"]],["util",[],["loaders.rs","mod.rs"]]],["error.rs","frontend.rs","intermediate_representation.rs","lib.rs","parser.rs"]]],\
...
["relevancy",["",[],["db.rs","error.rs","ingest.rs","interest.rs","lib.rs","ranker.rs","rs.rs","schema.rs","url_hash.rs"]]],\
["remote_settings",["",[],["cache.rs","client.rs","config.rs","error.rs","jexl_filter.rs","lib.rs","service.rs","storage.rs"]]],\
["restmail_client",["",[],["error.rs","lib.rs"]]],\
["search",["",[],["configuration_types.rs","environment_matching.rs","error.rs","filter.rs","lib.rs","selector.rs","types.rs"]]],\
["sql_support",["",[],["conn_ext.rs","debug_tools.rs","each_chunk.rs","lazy.rs","lib.rs","maybe_cached.rs","open_database.rs","repeat.rs"]]],\
["suggest",["",[["benchmarks",[],["client.rs","geoname.rs","ingest.rs","mod.rs","query.rs"]]],["config.rs","db.rs","error.rs","fakespot.rs","geoname.rs","lib.rs","metrics.rs","pocket.rs","provider.rs","query.rs","rs.rs","schema.rs","store.rs","suggestion.rs","util.rs","weather.rs","yelp.rs"]]],\
...
["types",["",[],["lib.rs"]]],\
["uniffi_bindgen_library_mode",["",[],["main.rs"]]],\
